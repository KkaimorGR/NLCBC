permissionset 52193494 GreenCom
{
    Assignable = true;
    Permissions = tabledata "Applicant Documents" = RIMD,
        ...
        tabledata "Store Requisition TT Line" = RIMD,
        ...
        table "Store Requisition TT Line" = X,
