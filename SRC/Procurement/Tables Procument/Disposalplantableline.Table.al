...
Table 52193479 "Disposal plan table line"
{
    ...
    fields
    {
        ...
        field(3; "Item description"; Text[500])
        {
            Editable = false;
            Caption = 'Description';
        }
        ...
        {
            TableRelation = "Disposal Methods"."Disposal Description";
        }
        ...
        field(50005; "Serial No"; Text[500])
        {
            Editable = false;
        }
        ...
        field(50007; "No."; Code[201])
        {
            TableRelation = "Fixed Asset" where(Acquired = const(true), Disposed = const(false));
        ...
        {
            CalcFormula = lookup("Disposal Plan Header".Status where("No." = field("Ref. No.")));
            Editable = true;
        ...
        {
            CalcFormula = lookup("Disposal Plan Header"."Disposal Status" where("No." = field("Ref. No.")));
            FieldClass = FlowField;
        ...
        {
            OptionCaption = ' Planning,CEO,Tender Committee,Disposal implementation,Disposed,Rejected';
            OptionMembers = " Planning",CEO,"Tender Committee","Disposal implementation",Disposed,Rejected;
        }
        ...
        field(50030; "Disposed To"; Text[300])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    var
        DisposalHeader: Record "Disposal Plan Header";
