...
Page 52193544 "Supply Chain Procurement"
{
    Caption = 'Role Center';
    PageType = RoleCenter;
    ...
    actions
    {
        area(reporting)
        {
            ...
            action("Stock Quantities")
            {
                ...
                Image = "Report";
                RunObject = Report "Stock Quantities";
            }
            ...
            action("Departmental Consumption Report")
            {
                ...
                Image = "Report";
                RunObject = Report "Dep Consumption Report";
            }
            action("Consumption Trend Analys")
            {
                ...
                Image = "Report";
                RunObject = Report "Consumption Trend Analysis";
            }
            ...
            action("Fixed Asset Movement Analysis")
            {
                ...
                Image = "Report";
                RunObject = Report "Fixed Asset Movement Analysis";
            }
            action("Fixed Asset - Registers")
            {
                ...
                Image = "Report";
                RunObject = Report "Fixed Asset - Registers";
            }
        }
        area(embedding)
        {
            ...
            group("Item")
            {
                ...
                action("All Items")
                {
                    ...
                    Caption = 'Open Items';
                    Image = Item;
                    RunObject = Page "Procurement Item List";
                ...
                // action("Rejected/Retuened Items")
                // {
                //     ApplicationArea = all;
                //     RunObject = page "Retuened/Rejected List";
                //     Caption = 'Rejected/Retuened Items';
                // }
                group("Returned Items")
                {
                    action("Open Returned Items")
                    {
                        ApplicationArea = all;
                        RunObject = page "Retuened/Rejected List";
                        Caption = 'Open Rejected/Returned Items';
                        RunPageView = where(Status = const(Open));
                    }
                    action("Pending Returned Items")
                    {
                        ApplicationArea = all;
                        RunObject = page "Retuened/Rejected List";
                        Caption = 'Pending Rejected/Returned Items';
                        RunPageView = where(Status = const("Pending Approval"));
                    }
                    action("Approved Returned Items")
                    {
                        ApplicationArea = all;
                        RunObject = page "Retuened/Rejected List";
                        Caption = 'Approved Rejected/Returned Items';
                        RunPageView = where(Status = const(Approved));
                    }
                    action("Rejected Returned Items")
                    {
                        ApplicationArea = all;
                        RunObject = page "Retuened/Rejected List";
                        Caption = 'Rejected/Returned Items';
                ...
                action("Return Items Report")
                {
                    ApplicationArea = Basic;
                    Caption = 'Return Items Report';
                    Image = Item;
                    Visible = true;
                    RunObject = Report "Inventory Return Form";
            ...
            action("All Fixed Asset")
            {
                ...
                RunPageLink = Returned = const(false);
            }
            group("Asset Reports")
            {
                action("All fixed Assets")
                {
                    ApplicationArea = all;
                    Image = Print;
                    RunObject = report "Fixed Asset - Acquisition List";
                    Caption = 'All fixed Assets';
                }
            ...
            action("Returned Fixed Asset")
            {
                ApplicationArea = Basic;
                Caption = 'Returned Fixed Asset';
                RunObject = Page "Fixed Asset List";
                RunPageLink = Returned = const(true);
            }
            ...
            action("Disposed Fixed Assets")
            {
                ...
                RunPageView = where("Line Status" = const(Posted), "Line Disposal Status" = const(Disposed));
            }
        ...
        area(sections)
        {
            ...
            group("Inventory Processing")
            {
                Caption = 'Inventory Processing';

                group("Inventory  Holding Area")
                {
                    Visible = false;
                    action("Open Inventory  Holding")
                    {
                        ApplicationArea = Basic;
                        Caption = 'Open Inventory  Holding';
                        RunObject = Page "Hodling List Area";
                        RunPageLink = Status = const(Open);

                    }
                    action("Pending Inventory  Holding")
                    {
                        ApplicationArea = Basic;
                        Caption = 'Pending Inventory  Inspection';
                        RunObject = Page "Hodling List Area";
                        RunPageLink = Status = const("Pending Approval");

                    }
                    action("Approved Inventory  Holding")
                    {
                        ApplicationArea = Basic;
                        Caption = 'Approved Inventory  Inspection';
                        RunObject = Page "Hodling List Area";
                        RunPageLink = Status = const(Approved);

                    }
                    action("Rejected Inventory  Holding")
                    {
                        ApplicationArea = Basic;
                        Caption = 'Rejected Inventory ';
                        RunObject = Page "Rejected Lines";
                        RunPageLink = Status = const(Approved);

                    }

                }
                group("Inventory  Receiving Process")
                {
                    Caption = 'Inventory Receiving Process';
                    Image = Departments;
                    ...
                    action("Open Items PO")
                    {
                        ...
                        RunObject = Page "Items Requisitions Lists";
                        //RunPageLink = Status = const(Open);
                        RunPageLink = Status = const(Open), "Document Type" = const(PR), "Action Type" = const(Item);
                    }
                    action("Pending Items PO")
                    {
                        ...
                        RunObject = Page "Items Requisitions Lists";
                        //RunPageLink = Status = const("Pending Approval");
                        RunPageLink = Status = const("Pending Approval"), "Document Type" = const(PR), "Action Type" = const(Item);
                    }
                    action("Approved Items PO")
                    {
                        ...
                        RunObject = Page "Items Requisitions Lists";
                        // RunPageLink = Status = const(Released);
                        RunPageLink = Status = const(Released), "Document Type" = const(PR), "Action Type" = const(Item);
                    ...
                    action("Rejected Items PO")
                    {
                        ...
                        //RunPageLink = Status = const(Rejected);
                        RunPageLink = Status = const(Rejected), "Document Type" = const(PR), "Action Type" = const(Item);
                    }
                    action("Posted Items PO")
                    {
                        ...
                        RunObject = Page "Items Requisitions Lists";
                        //RunPageLink = Status = const(Posted);
                        RunPageLink = Status = const(Posted), "Document Type" = const(PR), "Action Type" = const(Item);
                    }
                }
                group("Inventory  Issuing Process")
                {
                    Caption = 'Inventory  Issuing Process';
                    Image = Departments;
                    ...
                    action("Open Store Requisitions")
                    {
                        ...
                        RunObject = Page "Store Requisitions Lists 1";
                        RunPageLink = Status = const(Open), "Document Type" = const(SR);
                    }
                    action("Pending Approval Store Requisitions")
                    {
                        ...
                        RunObject = Page "Store Requisitions Lists 1";
                        RunPageLink = Status = const("Pending Approval"), "Document Type" = const(SR);
                    }
                    ...
                    action("Posted Store Requisitions")
                    {
                        ...
                        RunObject = Page "Store Requisitions Lists 1";
                        RunPageLink = Status = const(Posted), "Document Type" = const(SR);
                    }
                    action("Rejected Store Requisitions")
                    {
                        ...
                        RunObject = Page "Store Requisitions Lists 1";
                        RunPageView = where(Status = filter(Rejected), "Document Type" = const(SR));
                        //RunPageLink = Status = const(Rejected), "Document Type" = const(SR);
                    }
                }
            }
            group("Assets Processing")
            {
                group("Assets Receiving Process")
                {
                    ...
                    {
                        ApplicationArea = all;
                        Caption = 'Open Asset Recieving';
                        Visible = true;
                        RunObject = Page "Asset Reciving Card";
                        RunPageLink = Status = const(Open), "Document Type" = const(PR), "Action Type" = const(Asset);
                        // ("Document Type" = const(PR),
                    ...
                    action("Pending Asset PO")
                    {
                        ApplicationArea = all;
                        Visible = true;
                        Caption = 'Pending Asset Recieving';
                        RunObject = Page "Asset Reciving Card";
                        RunPageLink = Status = const("Pending Approval"), "Document Type" = const(PR), "Action Type" = const(Asset);
                    }
                    action("Approved Asset PO")
                    {
                        ApplicationArea = all;
                        Caption = 'Approved Asset Recieving';
                        Visible = true;
                        RunObject = Page "Asset Reciving Card";
                        RunPageLink = Status = const(Released), "Document Type" = const(PR), "Action Type" = const(Asset);
                    }
                    action("Posted Asset PO")
                    {
                        ApplicationArea = all;
                        Caption = 'Posted Asset Recieving';
                        Visible = true;
                        RunObject = Page "Asset Reciving Card";
                        RunPageLink = Status = const(Posted), "Document Type" = const(PR), "Action Type" = const(Asset);
                    }
                    action("Rejected Asset PO")
                    {
                        ApplicationArea = all;
                        Caption = 'Rejected Asset Recieving';
                        Visible = true;
                        RunObject = Page "Asset Reciving Card";
                        RunPageLink = Status = const(Rejected), "Document Type" = const(PR), "Action Type" = const(Asset);
                    }
                    // action("All Asset Receiving")
                    // {
                    //     ApplicationArea = all;
                    //     Caption = 'All Asset Recieving';
                    //     Visible = true;
                    //     RunObject = Page "Asset Reciving Card";
                ...
                group("Asset Allocation Process")
                {
                    ...
                    action("Pending Asset Allocation")
                    {
                        ApplicationArea = all;
                        RunObject = page "Asset Allocation LIst";
                        RunPageLink = Status = const("Pending Approval");
                    ...
                    action("Rejected Asset Allocation")
                    {
                        ApplicationArea = all;
                        RunObject = page "Asset Allocation LIst";
                        RunPageLink = Status = const(Rejected);
                    }
                    // action("All Asset Allocations")
                    // {
                    //     ApplicationArea = all;
                    //     RunObject = page "Asset Allocation LIst";
                    // }
                }
                group("Assets Issuing Process")
                {
                    Caption = 'Assets Issuing Process';
                    Image = SNInfo;
                    ...
                    {
                        ApplicationArea = Basic;
                        Caption = 'Open Asset Issuing Request';
                        RunObject = Page "Asset Allocation Request List";
                        RunPageLink = Status = const(Open);
                    }
                    ...
                    {
                        ApplicationArea = Basic;
                        Caption = 'Pending Asset Issuing Request';
                        RunObject = Page "Asset Allocation Request List";
                        RunPageLink = Status = const("Pending Approval");
                    }
                    ...
                    {
                        ApplicationArea = Basic;
                        Caption = 'Approved Asset Issuing Request';
                        RunObject = Page "Asset Allocation Request List";
                        RunPageLink = Status = const(Approved);
                    }
                    action("Posted Asset Allocation Request")
                    {
                        ApplicationArea = Basic;
                        Caption = 'Posted Asset Issuing Request';
                        RunObject = Page "Asset Allocation Request List";
                        RunPageLink = Status = const(Issued);
                    }
                    action("Rejected Asset Allocation Request")
                    {
                        ApplicationArea = Basic;
                        Caption = 'Rejected Asset Issuing Request';
                        RunObject = Page "Asset Allocation Request List";
                        RunPageLink = Status = const(Open),
                                        Rejected = const(true);
                    }
                    ...
                    // {
                    //     ApplicationArea = Basic;
                    //     Caption = 'All Asset Issuing Request';
                    //     RunObject = Page "Asset Allocation Request List";
                    // }
                }
                group("Assets Movement Process")
                {
                    Caption = 'Assets Movement/Transfer Process';
                    Image = SNInfo;
                    action("Asset Issue List")
                    {
                        ApplicationArea = Basic;
                        Caption = 'Asset Movement/Transfer List';
                ...
                group("Asset Returning Process")
                {
                    action("Open Returning Assets")
                    {
                        ApplicationArea = all;
                        RunObject = page "Asset Returning Lists";
                        RunPageLink = Status = const(open);
                    }
                    action("Pending Returning Assets")
                    {
                        ApplicationArea = all;
                        RunObject = page "Asset Returning Lists";
                        RunPageLink = Status = const("Pending Approval");
                    }
                    action("Approved Returning Assets")
                    {
                        ApplicationArea = all;
                        RunObject = page "Asset Returning Lists";
                        RunPageLink = Status = const(Approved);
                    }
                    // action("All Returning Assets")
                    // {
                    //     ApplicationArea = all;
                    //     RunObject = page "Asset Returning Lists";
                ...
                group("Fixed Asset Allocation Process")
                {
                    action("Open Allocation Assets")
                    {
                        ApplicationArea = all;
                        RunObject = page "Fixed Asset Allocation";
                        RunPageLink = Status = const(open);
                    }
                    action("Pending Allocation Assets")
                    {
                        ApplicationArea = all;
                        RunObject = page "Fixed Asset Allocation";
                        RunPageLink = Status = const("Pending Approval");
                    }
                    action("Approved Allocation Assets")
                    {
                        ApplicationArea = all;
                        RunObject = page "Fixed Asset Allocation";
                        RunPageLink = Status = const(Approved);
                    }
                    action("Rejected Allocation Assets")
                    {
                        ApplicationArea = all;
                        RunObject = page "Fixed Asset Allocation";
                        RunPageLink = Status = const(Rejected);
                    }
                    // action("All Allocation Assets")
                    // {
                    //     ApplicationArea = all;
                    //     RunObject = page "Fixed Asset Allocation";
            ...
            group("General Setups")
            {
                ...
                action("Purchases and Payables Setup")
                {
                    ApplicationArea = Basic;
                    Caption = 'Purchases and Payables Setup';
                    Description = 'General Setup';
                    Image = Setup;
