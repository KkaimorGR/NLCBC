...
Page 52193482 "Approved Disposal Asset Lines"
{
            ...
            group("<Action1102755026>")
            {
                ...
                action("Reject  Selected Disposal Lines")
                {
                    ...
                    begin
                        ...
                        Rec.SetRange(Rec.Select, true);
                        Rec.SetRange(Rec.Status, Rec.Status::Approved);
                        rec.SetRange(Rec."Line Disposal Status", Rec."Line Disposal Status"::" Planning");
                        if Rec.Find('-') then begin
                            repeat
                                ...
                                Rec."Line Disposal Status" := Rec."Line Disposal Status"::Rejected;
                                Rec.Modify;
