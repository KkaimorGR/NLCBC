...
tableextension 52193443 tableextension50116 extends "User Setup"
{
    fields
    {
        ...
        field(50121; "Edit Basic Salary"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50122; "Modify payroll"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50123; "Edit HR Setup"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50124; "Can Issue Asset"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(50125; "Can recceive"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(60006; "Can View Contracts"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
