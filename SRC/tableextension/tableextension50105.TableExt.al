...
tableextension 52193432 tableextension50105 extends Vendor
{
    fields
    {
        ...
        */
        ...
        field(500; Category; Option)
        {
            DataClassification = ToBeClassified;
            OptionMembers = " ",Goods,Services;
        }
        field(501; "Sub Category"; Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(502; "Agpo Categoty"; Option)
        {
            DataClassification = ToBeClassified;
            OptionMembers = "","AGpo Categorization",Citizenship;
        }
        field(503; "Descreption"; Text[300])
        {
            DataClassification = ToBeClassified;
        }
        field(504; Status; Option)
        {
            DataClassification = ToBeClassified;
