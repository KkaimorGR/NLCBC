...
report 52193542 "HR Applicant to Employee"
{
    ProcessingOnly = true;
    ...
    var
        myInt: Integer;
    begin
        Message('Employee Registration Details Created!');

    end;

    var
        HREmp: Record "HR Employee Registration";
    ...
    begin
        HREmp.Init();
        if "HR Job Applications"."Type of Contract Required" = "HR Job Applications"."Type of Contract Required"::Contract then begin
            HREmp."Contract Type" := HREmp."Contract Type"::Contract;
            HREmp.Validate(HREmp."Contract Type");
        end;
        if "HR Job Applications"."Type of Contract Required" = "HR Job Applications"."Type of Contract Required"::Permanent then begin
            HREmp."Contract Type" := HREmp."Contract Type"::"Permanent and Pensionable";
            HREmp.Validate(HREmp."Contract Type");
        end;
        if "HR Job Applications"."Type of Contract Required" = "HR Job Applications"."Type of Contract Required"::Internship then begin
            HREmp."Contract Type" := HREmp."Contract Type"::Intern;
            HREmp.Validate(HREmp."Contract Type");
        end;
        //  HREmp."Contract Type":="HR Job Applications".typ;
