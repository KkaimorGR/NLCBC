...
report 52193537 "Appraisal List Report"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            RequestFilterFields = "Appraisal No", "Appraisal Period", "Employee No", Supervisor, "Appraisal Score";
            column(ReportForNavId_1; 1) { }
            column(CompanyWebsite; CompanyWebsite)
            {
            }
            column(SupervisprTitle; SupervisprTitle)
            {
            ...
            begin
                SupervisprTitle := '';
                HrRecord.Reset();
                HrRecord.SetRange("No.", Supervisor);
                if HrRecord.Find('-') then
                    SupervisprTitle := HrRecord."Job Title";
