...
report 52193605 prNHIF
{
    ...
    dataset
    {
        dataitem("HR Employees"; "HR Employees")
        {
            ...
            column(HR_Employee__Last_Name_; UpperCase("First Name")) { }
            column(EmployeeName; UpperCase(EmployeeName)) { }
            ...
            column(ID; ID) { }
            column(Cell_Phone_Number; CellPhone)
            {
            ...
            begin
                ...
                //Counter:=Counter+1;
                CellPhone := '';
                if "HR Employees"."Cell Phone Number" = '' then
                    CellPhone := "HR Employees"."Home Phone Number"
                else
                    CellPhone := "HR Employees"."Cell Phone Number";
                if "HR Employees"."Middle Name" = '' then
                    EmployeeName := "HR Employees"."Last Name"
                else
                    EmployeeName := "HR Employees"."Middle Name";
