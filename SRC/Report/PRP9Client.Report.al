...
report 52193594 "PR P9 Client"
{
    ...
    dataset
    {
        dataitem("HR Employees"; "HR Employees")
        {
            ...
            RequestFilterFields = "No.", "Period Year";
            ...
            dataitem("PR Employee P9 Info"; "PR Employee P9 Info")
            {
                ...
                column(HousingLevy_PREmployeeP9Info; "PR Employee P9 Info"."Housing Levy") { }
                column(SHA_Relief; "PR Employee P9 Info"."SHA Relief") { }
    ...
    procedure Setselctedfield(Select: Integer): Integer
    var
        myInt: Integer;
    begin
