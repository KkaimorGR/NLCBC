...
report 52193460 "Training Applications"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            RequestFilterFields = Status, "Responsibility Center", "Application No", "Start Date";
            ...
            begin
                Pwd := '';
                EmployeeRe.Reset();
                EmployeeRe.SetRange("No.", "HR Training App Header"."Employee No_");
                if EmployeeRe.FindFirst() then begin
                    Pwd := Format(EmployeeRe.Disabled);
