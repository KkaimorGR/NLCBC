...
report 52193564 "PR Individual Payslip"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("HR Employees"; "HR Employees")
        {
            ...
            dataitem("PR Salary Card"; "PR Salary Card")
            {
                ...
                var
                    DateOpnned: Text;
                // "PR Salary Card".GetFilter("Period Filter");
                begin
                    ...
                    // "PR Salary Card".GetFilter("Period Filter");
                    JobHistory.Reset();
                    JobHistory.SetRange("Period Filter", "PR Salary Card"."Period Filter");
                    JobHistory.SetRange("No.", "PR Salary Card"."Employee Code");
                    if JobHistory.FindFirst() then
                        JobTitel := JobHistory."Job Title"
                    else
                        JobTitel := "HR Employees"."Job Title";
                    HREmployeePR.Reset();
