report 50068 "Furniture & Fitting Registers"
{
    Caption = 'Furniture & Fitting Registers';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Furniture&FittingRegisters.rdlc';
    ...
    dataset
    {
        dataitem("Fixed Asset"; "Fixed Asset")
        {
            ...
            // DataItemTableView = where(Type = const(1), Type = const(2));
            column(No_; "No.")
            {
            ...
            begin
                "Fixed Asset".SetFilter("FA Subclass Code", 'FURNITURE');
            end;
            ...
            //DisposalLine: Record "Disposal plan table line";
            begin
                LedgerEntries.Reset();
