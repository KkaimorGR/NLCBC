...
report 52193647 "priTax-Disabled"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("PR Period Transactions"; "PR Period Transactions")
        {
            ...
            begin
                ...
                PeriodTran1.SetRange(PeriodTran1."Employee Code", "PR Period Transactions"."Employee Code");
                PeriodTran1.SetRange(PeriodTran1."Payroll Period", SelectedPeriod);
                PeriodTran1.SetRange(PeriodTran1."Transaction Code", 'POST-RETIRE-RL');
                PeriodTran1.SetRange(PeriodTran1."Payroll Code", "PR Period Transactions"."Payroll Code");
                if PeriodTran1.Find('-') then
                    POSTRETIRERL := PeriodTran1.Amount;

                PeriodTran1.Reset();
                PeriodTran1.SetRange(PeriodTran1."Employee Code", "PR Period Transactions"."Employee Code");
                PeriodTran1.SetRange(PeriodTran1."Payroll Period", SelectedPeriod);
                PeriodTran1.SetRange(PeriodTran1."Transaction Code", 'MORG-RL');
                PeriodTran1.SetRange(PeriodTran1."Payroll Code", "PR Period Transactions"."Payroll Code");
                if PeriodTran1.Find('-') then
                    MORGRL := PeriodTran1.Amount;
                PeriodTran1.Reset();
                PeriodTran1.SetRange(PeriodTran1."Employee Code", "PR Period Transactions"."Employee Code");
                PeriodTran1.SetRange(PeriodTran1."Payroll Period", SelectedPeriod);
                PeriodTran1.SetRange(PeriodTran1."Transaction Code", 'HOUSING LEVY');
                PeriodTran1.SetRange(PeriodTran1."Payroll Code", "Payroll Code");
                if PeriodTran1.Find('-') then
                    HOSp := PeriodTran1.Amount;
                PeriodTran1.Reset();
                PeriodTran1.SetRange(PeriodTran1."Employee Code", "PR Period Transactions"."Employee Code");
                PeriodTran1.SetRange(PeriodTran1."Payroll Period", SelectedPeriod);
                PeriodTran1.SetRange(PeriodTran1."Transaction Code", 'SHA');
                PeriodTran1.SetRange(PeriodTran1."Payroll Code", "Payroll Code");
                if PeriodTran1.Find('-') then
                    "30% cash" := PeriodTran1.Amount;
                //prmf
                PeriodTran1.Reset();
                PeriodTran1.SetRange(PeriodTran1."Employee Code", "PR Period Transactions"."Employee Code");
                PeriodTran1.SetRange(PeriodTran1."Transaction Code", 'D466');
                PeriodTran1.SetRange(PeriodTran1."Payroll Period", SelectedPeriod);
                PeriodTran1.SetRange(PeriodTran1."Payroll Code", "Payroll Code");
                if PeriodTran1.Find('-') then
                    "permisable limit" := "permisable limit" + PeriodTran1.Amount;
                ...
                PeriodTran1.SetRange(PeriodTran1."Payroll Code", "PR Period Transactions"."Payroll Code");
                if PeriodTran1.Find('-') then
                    NSSFAmt := NSSFAmt + PeriodTran1.Amount;
    ...
    begin
        ...
        ExcelBuf.AddColumn('Persons With Disability (pwd)', false, '', false, false, false, '', 0);
        ...
        ExcelBuf.AddColumn('Value of meals', false, '', false, false, false, '', 0);
        ...
        ExcelBuf.AddColumn('Shif', false, '', false, false, false, '', 0);
        ExcelBuf.AddColumn('NSSF', false, '', false, false, false, '', 0);
        ExcelBuf.AddColumn('Actual contribution', false, '', false, false, false, '', 0);
        ExcelBuf.AddColumn('post Retirement M.F', false, '', false, false, false, '', 0);
        ExcelBuf.AddColumn('mortgage interest', false, '', false, false, false, '', 0);
        ExcelBuf.AddColumn('HOUSING LEVY', false, '', false, false, false, '', 0);
    ...
    begin
        ...
        if objEmp.Find('-') then begin
            if objEmp."Employee Type Primary" = objEmp."Employee Type Primary"::Secondary then
                EmployeType := 'Seconday Employee';
            if objEmp."Employee Type Primary" = objEmp."Employee Type Primary"::Primary then
                EmployeType := 'Primary Employee';
            ...
            ExcelBuf.AddColumn(EmployeType, false, '', false, false, false, '', 0);
            ExcelBuf.AddColumn(objEmp.Disabled, false, '', false, false, false, '', 0);
            ...
            ExcelBuf.AddColumn("30% cash", false, '', false, false, false, '', 0);  //"30% cash"
            ExcelBuf.AddColumn(NSSFAMT, false, '', false, false, false, '', 0);
            ExcelBuf.AddColumn("Actual contribution", false, '', false, false, false, '', 0);
            ExcelBuf.AddColumn("permisable limit", false, '', false, false, false, '', 0); //"permisable limit"
            ExcelBuf.AddColumn("mortgage interest", false, '', false, false, false, '', 0);
    ...
    begin
        ...
        // ExcelBuf.CreateBookAndOpenExcel('Sheet1', 'Sheet1', 'iTax', CompanyName, UserId);
        ExcelBuf.CloseBook();
