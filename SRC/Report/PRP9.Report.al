    ...
    dataset
    {
        ...
        dataitem("HR Employees"; "HR Employees")
        {
            ...
            dataitem("PR Employee P9 Info"; "PR Employee P9 Info")
            {
                ...
                begin
                    ...
                    if SelectedPeriod = 0 then begin
                        HrEmpl.Reset();
                        HrEmpl.SetRange("No.", "PR Employee P9 Info"."Employee Code");
                        if HrEmpl.FindFirst() then begin
                            SelectedPeriod := HrEmpl."Period Year";
                        end;
                    end;
                    P9PAYEAmount := 0;
                    PRPeriodTrans.Reset();
                ...
                begin
                    if SelectedPeriod = 0 then begin
                        HrEmpl.Reset();
                        HrEmpl.SetRange("No.", "HR Employees"."No.");
                        if HrEmpl.FindFirst() then begin
                            SelectedPeriod := HrEmpl."Period Year";
            ...
            begin
                EmployerPIN := '';
                PyrollSet.Get();
                EmployerPIN := PyrollSet."Employer PIN";
