...
report 52193724 "PR Employee Salary Increments1"
{
    ProcessingOnly = true;
    ApplicationArea = All;
            ...
            begin
                ...
                if HREmp.Find('-') then
                    repeat
                        ...
                        PRSalaryScale.Reset();
                        PRSalaryScale.SetRange(PRSalaryScale.Grade, CurrentEmployeeJobGroup);
                        PRSalaryScale.SetRange(PRSalaryScale."Basic Pay 11", CurrentEmployeeBasicPay);
                        if PRSalaryScale.Find('-') then begin
                            NewEmployeeBasicPay := PRSalaryScale."Basic Pay 12";
                        ...
                        PRSalaryScale.Reset();
                        PRSalaryScale.SetRange(PRSalaryScale.Grade, CurrentEmployeeJobGroup);
                        PRSalaryScale.SetRange(PRSalaryScale."Basic Pay 12", CurrentEmployeeBasicPay);
                        if PRSalaryScale.Find('-') then begin
                            NewEmployeeBasicPay := PRSalaryScale."Basic Pay 13";
                        ...
                        PRSalaryScale.Reset();
                        PRSalaryScale.SetRange(PRSalaryScale.Grade, CurrentEmployeeJobGroup);
                        PRSalaryScale.SetRange(PRSalaryScale."Basic Pay 13", CurrentEmployeeBasicPay);
                        if PRSalaryScale.Find('-') then begin
                            NewEmployeeBasicPay := PRSalaryScale."Basic Pay 14";
                        ...
                        PRSalaryScale.Reset();
                        PRSalaryScale.SetRange(PRSalaryScale.Grade, CurrentEmployeeJobGroup);
                        PRSalaryScale.SetRange(PRSalaryScale."Basic Pay 14", CurrentEmployeeBasicPay);
                        if PRSalaryScale.Find('-') then begin
                            NewEmployeeBasicPay := PRSalaryScale."Basic Pay 15";
                            //MODIFY BASIC PAY OF EMPLOYEE
                            HREmp2.Reset();
                            HREmp2.SetRange(HREmp2."No.", HREmp."No.");
                            if HREmp2.Find('-') then begin
                        ...
                        PRSalaryScale.Reset();
                        PRSalaryScale.SetRange(PRSalaryScale.Grade, CurrentEmployeeJobGroup);
                        PRSalaryScale.SetRange(PRSalaryScale."Basic Pay 15", CurrentEmployeeBasicPay);
                        if PRSalaryScale.Find('-') then begin
                            NewEmployeeBasicPay := PRSalaryScale."Basic Pay 16";
                            //MODIFY BASIC PAY OF EMPLOYEE
                            HREmp2.Reset();
                            HREmp2.SetRange(HREmp2."No.", HREmp."No.");
                            if HREmp2.Find('-') then begin
                        ...
                        PRSalaryScale.Reset();
                        PRSalaryScale.SetRange(PRSalaryScale.Grade, CurrentEmployeeJobGroup);
                        PRSalaryScale.SetRange(PRSalaryScale."Basic Pay 16", CurrentEmployeeBasicPay);
                        if PRSalaryScale.Find('-') then begin
                            NewEmployeeBasicPay := PRSalaryScale."Basic Pay 17";
                            //MODIFY BASIC PAY OF EMPLOYEE
                            HREmp2.Reset();
                            HREmp2.SetRange(HREmp2."No.", HREmp."No.");
                            if HREmp2.Find('-') then begin
                        ...
                        PRSalaryScale.Reset();
                        PRSalaryScale.SetRange(PRSalaryScale.Grade, CurrentEmployeeJobGroup);
                        PRSalaryScale.SetRange(PRSalaryScale."Basic Pay 17", CurrentEmployeeBasicPay);
                        if PRSalaryScale.Find('-') then begin
                            NewEmployeeBasicPay := PRSalaryScale."Basic Pay 18";
                            //MODIFY BASIC PAY OF EMPLOYEE
                            HREmp2.Reset();
                            HREmp2.SetRange(HREmp2."No.", HREmp."No.");
                            if HREmp2.Find('-') then begin
                        ...
                        PRSalaryScale.Reset();
                        PRSalaryScale.SetRange(PRSalaryScale.Grade, CurrentEmployeeJobGroup);
                        PRSalaryScale.SetRange(PRSalaryScale."Basic Pay 18", CurrentEmployeeBasicPay);
                        if PRSalaryScale.Find('-') then begin
                            NewEmployeeBasicPay := PRSalaryScale."Basic Pay 19";
                            //MODIFY BASIC PAY OF EMPLOYEE
                            HREmp2.Reset();
                            HREmp2.SetRange(HREmp2."No.", HREmp."No.");
                            if HREmp2.Find('-') then begin
                        ...
                        if PRSalaryScale.Find('-') then begin
                            NewEmployeeBasicPay := PRSalaryScale."Basic Pay 11";
