...
pageextension 52193439 pageextension50112 extends "General Journal"
{
    layout
    {
            ...
            group(ActionGroup47)
            {
                action(Approvals1)
                {
                    ...
                    begin
                        ...
                        if GenJnlBatch.Find('-') then begin
                            ApprovalEntries.SetRecordFilters(Database::"Gen. Journal Batch", DocType, GenJnlBatch.BatchApprovalNo);
                            ApprovalEntries.Run();
                        end;
                    end;
                }
