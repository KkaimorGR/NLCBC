...
page 52193582 "Asset Return card"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = all;
                    // OptionCaption = 'Asset Transfer,Asset Allocation,Asset Incidence,Returning';
                    Editable = false;
                }
                field(Type; Type)
                {
            ...
            part(Control9; "Asset Returning Lines")
            {
                Editable = Line;
                // Visible=rec."Document Type"="Document Type"::Returning;
        ...
        area(processing)
        {
            ...
            action("Attach Documents")
            {
                ...
                begin
                    ...
                    DMSManagement.GetDocument(DocType, Rec."No.", Rec.RecordID, 'BMA', 52193494, 'Asset Returning', '');
    ...
    begin
        ...
        "Document Type" := "document type"::Returning;
        Type := Type::Return
    end;
