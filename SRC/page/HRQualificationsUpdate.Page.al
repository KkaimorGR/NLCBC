page 52193460 "HR Qualifications Update"
{
    ApplicationArea = All;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Qualification Level"; Rec."Qualification Type")
                {
                ...
                field("Qualification Name"; Rec."Other Qualification/Course Name")
                {
                    Editable = OtherQua;
        ...
        area(FactBoxes)
        {
            part("Attached Documents"; "Document Attachment Factbox")
            {
                ...
                Caption = 'Attachments';
                //Visible = false;
                SubPageLink = "Table ID" = CONST(50006),
                              "No." = FIELD("Qualfi Code");
            }
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(Attachments)
            {
                ...
                Image = Attach;
                Promoted = true;
                RunObject = page "Document Attachment Factbox";
            ...
            action(TestReport)
            {
                ...
                var
                    ...
                    Sttes: Text;
                begin
                    Sttes := ERecruitment.FnApplicantProfileRegistration(prefix::Doctor, '009', 'Kaimor', 'Sharks', 'Nickel', gender::Male, 3, '', '', religion::Christianity, 19980707D, '', '', '', '', '', maritalstatus::Married, '', '', '', '', false, '', 1, 2, 'DEGREE', '', '', '', '', '', 2);
                    Message(Sttes);
                end;
            }
