...
page 52193473 "Advertised Requisitions"
{
    ...
    layout
    {
        area(Content)
        {
            repeater(Control1102755000)
            {
                ...
                {
                    ApplicationArea = all;
                    ToolTip = 'Executes expected experience in years';
                }
            }
        }
        area(FactBoxes)
    ...
    begin
        ...
        // HRRequist.Reset();
        // HRRequist.SetRange("Closing Date", Today);
        // HRRequist.SetRange("Requisition No.", rec."Requisition No.");
        // if HRRequist.Find('-') then begin
