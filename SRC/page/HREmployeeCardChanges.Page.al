...
page 52194383 "HR Employee Card - Changes"
{
    PageType = Card;
    ...
    begin
        ...
        if PayLines.Find('-') then begin
            repeat
                if (PayLines."Employee No" = '') or (PayLines."New Bank  Code" = '') or (PayLines."New Branch Code" = '') or (PayLines."New A/C  Number" = '') or (PayLines."From payroll Period" = 0D) or (PayLines."Percentage to Transfer" = 0) then
