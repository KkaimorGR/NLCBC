...
page 52194246 "HR Training Needs Card"
{
    DeleteAllowed = false;
    PageType = Card;
    ...
    layout
    {
            ...
            group(General)
            {
                ...
                field(Location; Rec.Location)
                {
                    ...
                    var
                        myInt: Integer;
                    begin
                        rec.TestField("Course Description");
                    end;
                }
        ...
        area(FactBoxes)
        {
            part("Attached Documents"; "Document Attachment Factbox")
            {
                ...
                Caption = 'Attachments';
                //Visible = false;
                SubPageLink = "Table ID" = CONST(52193497),
                              "No." = FIELD(Code);
            }
