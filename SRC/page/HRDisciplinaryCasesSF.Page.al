...
page 50023 "HR Disciplinary Cases SF"
{
    PageType = Card;
        ...
        area(Processing)
        {
            group(ActionGroup4)
            {
                ...
                action(TestVEh)
                {
                    ...
                    trigger OnAction()
                    var
                        porta: Codeunit PortalWebService;

                    begin
                        porta.UpdateVehicleAndDriver('TRREQ-0001', 'GKB 382D', 'GKB 386D', 'NLC20150112')
            ...
            group("Case Management")
            {
                ...
                action("Case Witnesses")
                {
                    ...
                    RunPageLink = "Case Number" = field("Document No.");
    ...
    begin
        if rec.Response = '' then begin
            ...
            if EmployeRec.FindFirst() then begin
                ...
                EmailManager.Create(EmployeRec."Company E-Mail", 'Disciplinary Notifications', msg, true);
                Email.Send(EmailManager, Enum::"Email Scenario"::Default);
                Message('Email sent successfully');
            end;
        end;
