...
page 52193639 "HR Employee Requisition Card"
{
    DeleteAllowed = false;
    InsertAllowed = true;
    PageType = Card;
    ...
    layout
    {
        area(Content)
        {
            group(General)
            {
                ...
                field("Required Positions"; Rec."Required Positions")
                {
                    ...
                    begin
                        if rec.Status = rec.Status::"Pending Approval" then begin
                            Approvalentry.Reset();
                            Approvalentry.SetRange("Document No.", rec."Requisition No.");
                            Approvalentry.SetRange("Approver ID", UserId);
                            if not Approvalentry.Find('-') then begin
                                Error('You do not have rights to amend this Requisition');
                            end;
                ...
                field("Directorates Name"; "Directorates Name")
                {
                    ApplicationArea = all;
                ...
                field("Expected Experience"; "Expected Experience")
                {
                    ApplicationArea = all;
                }
            }
            ...
            group("Close/Cancell Comments")
            {
                Visible = rec.Advertised = true;
                field("Close Comments"; "Close Comments")
                {
                    ApplicationArea = all;
                    Editable = Rec.Advertised = true;
                }
            }
        }
        area(FactBoxes)
        ...
        area(Navigation)
        {
            group("Workflow Process")
            {
                ...
                action("&Send Approval Request")
                {
                    ...
                    begin
                        ...
                        rec.TestField("Expected Experience");
            ...
            group(Requisition)
            {
                ...
                action("Monthy Salary Scale")
                {
                    ...
                    RunObject = page "Job Monthy Salary";
                    RunPageLink = "Job ID" = field("Job ID");
                    ToolTip = 'Executes the Monthly salary Scale action.';
                }
                action(Requirements)
                {
                    ApplicationArea = Basic;
                ...
                action(Advertise)
                {
                    ...
                    begin
                        ...
                        if rec."Requisition Type" <> rec."Requisition Type"::External then begin
                            ...
                            HrEmployees.SetFilter(HrEmployees."Contract Type", '<>%1', (HrEmployees."Contract Type"::Intern));
                            ...
                            Message('[%1] Employees have been notified about this vacancy', TEmpCou);
                        end;
                        Rec.Advertised := true;
                        Rec.Modify();
                        CurrPage.Close();
