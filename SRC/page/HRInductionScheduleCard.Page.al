...
page 52194317 "HR Induction Schedule Card"
{
    PageType = Card;
            ...
            action("&Approvals")
            {
                ...
                begin
                    ...
                    if Inductionschedule.Find('-') then begin
                        ...
                        ApprovalEntries.SetRecordFilters(Database::"HR Induction Schedule", DocumentType, Inductionschedule."Department Code");
                        ApprovalEntries.Run();
                    end else
