...
page 52193727 "prRates & Ceilings"
{
    ...
    layout
    {
        area(Content)
        {
            ...
            group(Pension)
            {
                ...
                field("Post Retirement Max"; "Post Retirement Max")
                {
                    ApplicationArea = all;
                    ToolTip = 'Specifies the value of the Tax On Excess post retirement relief field.';
                }
            }
            group(Mortgage)
            {
