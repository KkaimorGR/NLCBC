...
page 52194376 "HR Role Centre (HR ALL)"
{
    Caption = 'Role Center';
    PageType = RoleCenter;
    ApplicationArea = All;
    ...
    actions
    {
        area(sections)
        {
            group("HR Activities")
            {
                ...
                group("HR Employee Recruitment")
                {
                    ...
                    group("HR Employee Requisitions")
                    {
                        ...
                        action("Closed Employee Requisitions")
                        {
                            ...
                            RunObject = page "HR Employee Requisitions List";
                            RunPageLink = Status = filter(Approved), Closed = const(true);
                            ToolTip = 'Executes the HR Employee Requisitions action.';
                        }
                    }
                ...
                group("HR Leave Management")
                {
                    ...
                    group("Leave Plan Management")
                    {
                        ...
                        action("Rejected Leave Planner")
                        {
                            Image = Planning;
                            ApplicationArea = Basic;
                            Caption = 'Rejected Leave Planner';
                            RunObject = page "HR Leave Planner List";
                ...
                group("HR Performance Management")
                {
                    ...
                    action("Appraisal List")
                    {
                        ...
                        RunObject = page "Appraisal List0";
                ...
                group("HR Employee Transfer")
                {
                    ...
                    {
                        Caption = 'Self Employee Transfer';
            ...
            group("HR General Setup")
            {
                ...
                action("Scoring Template")
                {
                    ApplicationArea = all;
                    Caption = 'Scoring Template';
                    RunObject = page "Scoring List";
                    ToolTip = 'Scoring Templates';
                }
                ...
                group(Administration)
                {
                    ...
                    action("Users")
                    {
                        ...
                        ToolTip = 'Specifies the Users in the system';
                    }
                    action("User settings")
                    {
                        ...
                        ToolTip = 'Specifies the values of the user settings on roles';
                    }
                }
                action("Online Users")
                {
                    ApplicationArea = all;
                    RunObject = page "Staff Online Users";
                }
            }
        }
        area(Reporting)
        {
            ...
            {
                action("HR Vehicle Movement")
                {
                    ApplicationArea = all;
                    Caption = 'HR Vehicle Movement';
                    Image = SalesShipment;
                    Promoted = true;

                    RunObject = report "Vehicle Movement";
                    ToolTip = 'Executes the HR Transport Allocations action.';
                }
            ...
            group(Training)
            {
                ...
                action("Training Needs Assessment")
                {
                    ApplicationArea = All;
                    Caption = 'Training Needs Assessment';
                    RunObject = report "Training Needs Assessment";
