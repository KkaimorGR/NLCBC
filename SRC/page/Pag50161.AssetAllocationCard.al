...
page 52193586 "Asset Allocation Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part(Control9; "Asset Allocation Lines")
            {
                Editable = Line;
        ...
        area(processing)
        {
            ...
            action("Attach Documents")
            {
                ...
                begin
                    ...
                    //52193551
                    DMSManagement.GetDocument(DocType, Rec."No.", Rec.RecordID, 'BMA', 52193494, 'Asset Allocation', '');
