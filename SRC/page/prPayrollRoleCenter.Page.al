...
page 52193735 "prPayroll Role Center"
{
    Caption = 'Role Center';
    PageType = RoleCenter;
    ApplicationArea = All;
    ...
    actions
    {
        area(Reporting)
        {
            ...
            {
                action("PR Individual Payslip Portal")
                {
                    ApplicationArea = all;
                    Caption = 'PR Individual Payslip';
                    RunObject = report "PR Individual Payslip Portal";
                    ToolTip = 'Specifies the individual payslip';
                }
                action("PR NSSF")
                {
                ...
                {
                    ApplicationArea = All;
                    Caption = 'PR Individual Comparison Report';
        ...
        area(embedding)
        {
            group("Employee Bank Changes")
            {
                action("Open Employee Bank Changes")
                {
                    ApplicationArea = All;
                    Caption = 'Open Employee Bank Changes';
                ...
                action("Pending Employee Bank Changes")
                {
                    ApplicationArea = All;
                    Caption = 'Pending Employee Bank Changes';
                    RunObject = page "HR Employee List - Changes";
                    RunPageLink = "Approval Status" = filter("Pending Approval");
                    ToolTip = 'Executes the Employee Bank Changes action.';
                }
                action("Approved Employee Bank Changes")
                {
                    ApplicationArea = All;
                    Caption = 'Approved Employee Bank Changes';
                    RunObject = page "HR Employee List - Changes";
                    RunPageLink = "Approval Status" = filter(Approved);
                    ToolTip = 'Executes the Employee Bank Changes action.';
                }
                action("Cancelled Employee Bank Changes")
                {
                    ApplicationArea = All;
                    Caption = 'Cancelled Employee Bank Changes';
                    RunObject = page "HR Employee List - Changes";
                    RunPageLink = "Approval Status" = filter(Canceled);
                    ToolTip = 'Executes the Employee Bank Changes action.';
                }
            }
            group("Modifying Staff Payroll")
            {
                ...
                action("Modifying Change List Existing")
                {
                    ApplicationArea = All;
                    Caption = 'Pending Approval Staff Payroll';
                    RunObject = page "Payroll Change Lists Existing";
                    RunPageLink = Status = filter("Pending Approval");
                    ToolTip = 'Executes the Payroll Changes Existing Staff action.';
                }
                action("Approved Change List Existing")
                {
                    ApplicationArea = All;
                    Caption = 'Approved Approval Staff Payroll';
                    RunObject = page "Payroll Change Lists Existing";
        ...
        area(sections)
        {
            ...
            group("Employee Tasks")
            {
                ...
                {
                    ApplicationArea = Basic;
                    Caption = 'Open Salary Advance Request';
