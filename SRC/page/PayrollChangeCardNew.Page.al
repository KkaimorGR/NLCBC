...
page 52193978 "Payroll Change Card New"
{
    PageType = Card;
    SourceTable = "Payroll Change";
    ApplicationArea = All;
    Caption = 'Payroll Change Card New';
    PromotedActionCategories = 'New,Process,Report,Workflow Process,Document Comments';
    layout
    {
        area(Content)
        {
        ...
        area(Creation)
        {
            action(Approvals)
            {
                ...
                begin
                    ...
                    ApprovalEntries.SetRecordFilters(Database::"Payroll Change", DocumentType, Rec."Payroll Change No");
                    ApprovalEntries.Run();
                end;
            }
            ...
            action("HR Appraisal Comments")
            {
                ...
                RunPageLink = "Sal No." = field("Payroll Change No");
            }
        }
    }
