...
page 52193737 "PR Salary List (ALL)"
{
    ...
    actions
    {
        ...
        area(Processing)
        {
                    ...
                    if Answer = true then begin
                        ...
                        if PRSalaryCard.Get(Rec."No.") then begin
                            ...
                            if HREmployeePR.Find('-') then begin
                                ...
                                HRBankSummary.Reset();
                                HRBankSummary.SetRange(HRBankSummary."Payroll Period", SelectedPeriod);
                                ...
                                repeat
                                    ...
                                    if PRSalaryCard.Get(HREmployeePR."No.") then
                                        ...
                                        HREmployeePR.County, PRSalaryCard."Insurance Certificate?", PRSalaryCard."Pays Housing Levy", PRSalaryCard."Pays NITA")
                                ...
                                ProcessPayroll.Pensionarreas(SelectedPeriod);
            ...
            action("Clear N Basic Pay")
            {
                ApplicationArea = Basic;
                Promoted = true;
                Caption = 'Clear New Basic Pay';
            ...
            action("Update Single Salary Increment")
            {
                ApplicationArea = Basic;
                ToolTip = 'Executes the Update Salary Increments action.';
                Promoted = true;
