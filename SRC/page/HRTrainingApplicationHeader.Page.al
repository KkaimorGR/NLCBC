...
page 52194249 "HR Training Application Header"
{
    DeleteAllowed = false;
    PageType = Card;
    ...
    layout
    {
        area(Content)
        {
            group(General)
            {
                ...
                field("Perfomance Code"; "Perfomance Code")
                {
                    ApplicationArea = all;
                }
                field("Perfomance Course"; "Perfomance Course")
                {
                    ApplicationArea = all;
                }
        ...
        area(Navigation)
        {
            group("&Show")
            {
                ...
                action(Comments)
                {
                    ...
                    //     ApprovalComments.SetRecordFilters(Database::"HR Training App Header", DocumentType, Rec."Application No");
