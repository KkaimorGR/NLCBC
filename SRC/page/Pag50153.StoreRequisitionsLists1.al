...
page 52193578 "Store Requisitions Lists 1"
{
            ...
            group("<Action1102755026>")
            {
                ...
                action("<Action1102755032>")
                {
                    ...
                    begin
                        ...
                        ApprovalEntries.SetRecordFilters(Database::"Store Requistion Headers", DocumentType, Rec."No.");
                        ApprovalEntries.Run();
                    end;
                }
                ...
                action("<Action1102755036>")
                {
                    ...
                    begin
                        ...
                        Report.Run(Report::"Receipt Voucher S11", true, true, Rec);
                        Rec.Reset();
                    end;
                }
            }
