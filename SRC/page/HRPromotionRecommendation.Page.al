...
page 52194273 "HR Promotion Recommendation"
{
    //DeleteAllowed = false;
    PageType = Card;
    PromotedActionCategories = 'New,Process,Reports,Workflow Process,Promotion,Employee History,Comments,Document Attachment';
    ...
    layout
    {
        ...
        area(FactBoxes)
        {
            part("Attached Documents"; "Document Attachment Factbox")
            {
                ...
                Caption = 'Attachments';
                //Visible = false;
                SubPageLink = "Table ID" = CONST(52193508),
                              "No." = FIELD(No);
            }
        }
    }
            ...
            group("Request Approval")
            {
                ...
                action(AttachDoc)
                {
                    ...
                    var
                        myInt: Integer;
                        RecRef: RecordRef;
                        Hrpro: Record "HR Promo. Recommend Header";
                        DocAttachment: Record "Document Attachment";
                        Doctetails: page "Document Attachment Details";
                    begin
                        RecRef.Open(DATABASE::"HR Promo. Recommend Header");
                        if Hrpro.Get(Rec.No) then begin
                            RecRef.GetTable(Hrpro);
                            Doctetails.OpenForRecRef(RecRef);
                            Doctetails.RunModal();
                        end;
                    end;
                }
                ...
                action(Approvals)
                {
                    ...
                    begin
                        ...
                        // ApprovalEntries.SetRecordFilters(Database::"HR Promo. Recommend Header", DocumentType, Rec.No);
                        // ApprovalEntries.Run();
