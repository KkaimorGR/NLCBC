...
page 52194248 "HR Training Needs List"
{
    ...
    layout
    {
        area(Content)
        {
            repeater(Control1000000000)
            {
                ...
                field(Description; Rec."Qualification Description")
                {
                    ApplicationArea = Basic;
            ...
            group(Functions)
            {
                ...
                action(Approvals)
                {
                    ...
                    begin
                        ...
                        ApprovalEntries.SetRecordFilters(Database::"HR Training Needs", DocumentType, Rec.Code);
                        ApprovalEntries.Run();
                    end;
                }
