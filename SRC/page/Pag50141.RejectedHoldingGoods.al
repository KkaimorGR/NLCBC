...
page 52193566 "Rejected Holding Goods"
{
    ApplicationArea = All;
    Caption = 'Rejected Holding Goods';
    PageType = Card;
    ...
    layout
    {
        area(Content)
        {
            ...
            part("Rejected Goods";"Rejected Goods")
            {
                ApplicationArea = all;
                SubPageLink = "Holding No" = field("H Code"),Status=const(Rejected);
            }
