...
table 52193589 "PR Transaction Codes"
{
    ...
    fields
    {
        ...
        field(18; "Special Transactions"; Option)
        {
            ...
            OptionMembers = Ignore,"Defined Contribution","Home Ownership Savings Plan","Life Insurance","Owner Occupier Interest","Prescribed Benefit","Salary Arrears","Staff Loan","Value of Quarters",Mortgage,Pension,"Mortgage Relief","Post Retirement";
