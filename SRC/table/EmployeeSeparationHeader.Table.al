    ...
    fields
    {
        ...
        field(2; "Staff Code"; Code[50])
        {
            ...
            begin
                UserSet.Get(UserId);
                employeeRe.Reset();
                employeeRe.SetRange("User ID", UserSet."User ID");
                if employeeRe.Find('-') then
                    Error('You cannot capture your own seperation');
                Sepration.Reset();
        ...
        {
            OptionMembers = " ",Resignation,Death,Retirement,Termination,Sickness,Dismissal,"Retirement Under 50 Year Rule";
            OptionCaption = ' ,Resignation,Death,Mandatory Retirement,Termination OF Contract,Retirement on Medical Grounds,Dismissal,Retirement Under 50 Year Rule';
