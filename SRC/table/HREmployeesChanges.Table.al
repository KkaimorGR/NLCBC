...
table 52193893 "HR Employees - Changes"
{
    ...
    DrillDownPageId = "HR Employee Card - Changes";
    LookupPageId = "HR Employee Card - Changes";
        ...
        field(39003937; "Approval Status"; Option)
        {
            ...
            begin
                if rec."Approval Status" = rec."Approval Status"::Approved then begin
                    ...
                    TransferLines.Reset();
                    TransferLines.SetRange(TransferLines."Request No", rec.Code);
                    if TransferLines.Find('-') then begin
                        repeat
                            ...
                            if BankLines.Find('-') then begin
                                ...
                                BankLines.Reset();
                                if BankLines.FindSet() then begin
                                    LineN := BankLines.Count;
                                    BankLines.Init();
                                    BankLines."Line No." := LineN + 1;
                                    BankLines."From payroll Period" := TransferLines."From payroll Period";
                                    BankLines."Employee Code" := TransferLines."Employee No";
                                    BankLines."Bank  Code" := TransferLines."New Bank  Code";
                                    BankLines."Bank Name" := TransferLines."New Bank Name";
                                    BankLines."Branch Code" := TransferLines."New Branch Code";
                                    BankLines."Branch Name" := TransferLines."New Branch Name";
