...
table 52193428 "HR Job Applications"
{
    ...
    fields
    {
        ...
        {
            TableRelation = "HR Employee Requisitions"."Requisition No." where(Status = const(Approved));
        ...
        field(74; "Date of Interview"; Date)
        {
            ...
            var
                myInt: Integer;
            begin
                if rec."Date of Interview" < Today then
                    Error('You cannot back date interview date');
        ...
        field(84; "Approval Status"; Option)
        {
            ...
            begin
                if rec."Approval Status" = rec."Approval Status"::Approved then begin
                    rec."Application Status" := rec."Application Status"::Successful;
                end;
        ...
        field(103; "Candidate No."; Code[40])
        {
            ...
            begin
                if Applicant.Get("Candidate No.") then begin
                    ...
                    JobApplicantsQualification.SetRange("Candidate No.", Applicant."Candidate No.");
                    ...
                    if Applicant.Disabled = true then
                        rec.Disabled := 'Yes'
                    else
                        rec.Disabled := 'No';
                    rec.Validate("Date Of Birth");
                    // rec."Cummulative Experience" := Applicant."Cummulative Experience";
                    "Post Code" := Applicant."Post Code";
                    rec."First Language" := Applicant."First Language";
                    rec."Additional Language" := Applicant."Additioanla language";
                    City := Applicant.City;
                    "Additional Language" := Applicant."Ethnic Group";
                    Gender := Applicant.Gender;
                    rec."Application Status" := rec."Application Status"::Pending;
                    ...
                    rec."Disability CertNo" := Applicant."Disability Certificate No";
                    rec."Disabling Details" := Applicant."Disability Description";
                end;
            end;
        }
        field(104; "Type of Contract Required"; Option)
        {
        ...
        field(105; "Document Comment"; Text[300])
        {
            DataClassification = ToBeClassified;
        }
        field(106; "T Scores"; Decimal)
        {
        ...
        field(107; "First Language"; Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(108; "Cummulative Experience"; Integer)
        {
            DataClassification = ToBeClassified;
        }
        ...
        {
            DataClassification = ToBeClassified;
            OptionMembers = " ",Inprogress,Successful,Unsuccessful,Pending;
        }
