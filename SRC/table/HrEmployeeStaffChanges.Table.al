table 50007 "HR Employee Staff Changes"
{
    ...
    fields
    {
        ...
        field(500; "Employee No"; Code[20])
        {
            ...
            TableRelation = "HR Employees"."No." where(Status = filter(<> New));
            ...
            begin
                ...
                if HrEmpRec.FindFirst() then begin
                    ...
                    rec."Type of Employee" := HrEmpRec."Type of Employee";
                    rec.Acting := HrEmpRec.Acting;
                    ...
                    rec."PIN No." := HrEmpRec."PIN No.";
                    rec."NSSF No." := HrEmpRec."NSSF No.";
                    rec."Job ID5" := HrEmpRec."Job ID5";
                    rec."Job Title5" := HrEmpRec."Job Title5";
                    rec."Reason For Acting" := HrEmpRec."Reason For Acting";
                    rec."NHIF No." := HrEmpRec."NHIF No.";
                    rec."If Acted?" := HrEmpRec."If Acted?";
                    REC."Work Phone Number" := HrEmpRec."Work Phone Number";
                    ...
                    rec."Incremental Month" := HrEmpRec."Incremental Month";
                    rec."Date of Current Employment" := HrEmpRec."Date of Current Employment";
                    ...
                    rec."Exemption Certificate No." := HrEmpRec."Exemption Certificate No.";
                    ...
                    rec."Basic Pay" := HrEmpRec."Basic Pay";
                    rec."New Basic Pay" := HrEmpRec."New Basic Pay";
                    ...
                    rec.Religion := HrEmpRec.Religion;
                    rec."Department acting" := HrEmpRec."Department acting";
                    rec."DEpartment acting Name" := HrEmpRec."Department acting Name";
                    ...
                    //ADDED
                    Rec."Can Issue" := HrEmpRec."Can Issue";
                    GetNextofkin();
                end;
        ...
        field(12; County; Code[30])
        {
            ...
            begin
                ValuesRE.Reset();
                ValuesRE.SetRange(ValuesRE.Code, Rec.County);
                if ValuesRE.FindFirst() then
                    Rec.County := ValuesRE.Name;
            end;
        }
        ...
        field(17; "E-Mail"; Text[30])
        {
            ...
            var
                myInt: Integer;
            begin
                "Old Value" += ',' + xRec."E-Mail";
                if "Old Value" <> '' then begin
                    rec."New Value" += ',' + rec."E-Mail";
                    rec."Field Modified" += ',' + rec.FieldName("E-Mail");
                end;
            end;
        }
        ...
        field(21; "ID Number"; Code[20])
        {
            ...
            var
                myInt: Integer;
            begin
                "Old Value" += ',' + xRec."ID Number";
                if "Old Value" <> '' then begin
                    rec."New Value" += ',' + rec."ID Number";
                    rec."Field Modified" += ',' + rec.FieldName("ID Number");
                end;
            end;
        ...
        field(31; Status; Option)
        {
            ...
            trigger OnValidate()
            begin
                "Old Value" += ',' + Format(xRec.Status);
                if "Old Value" <> '' then begin
                    rec."New Value" += ',' + Format(rec.Status);
                    rec."Field Modified" += ',' + rec.FieldName(Status);
                end;
            end;
        }
        ...
        field(113; "Job ID"; Code[30])
        {
            ...
            begin
                ...
                "Old Value" += ',' + xRec."Job ID";
                if "Old Value" <> '' then begin
                    rec."New Value" += ',' + rec."Job ID";
                    rec."Field Modified" += ',' + rec.FieldName("Job ID");
                end;
            end;
        }
        ...
        field(145; "PIN No."; Code[20])
        {
            ...
            begin
                "Old Value" += ',' + "PIN No.";
                if "Old Value" <> '' then begin
                    rec."New Value" += ',' + rec."PIN No.";
                    rec."Field Modified" += ',' + rec.FieldName("PIN No.");
                end;
            end;
        }
        ...
        field(147; "NHIF No."; Code[20])
        {
            ...
            var
                myInt: Integer;
            begin
                "Old Value" += ',' + xRec."NHIF No.";
                if "Old Value" <> '' then begin
                    rec."New Value" += ',' + rec."NHIF No.";
                    rec."Field Modified" += ',' + rec.FieldName("NHIF No.");
                end;
            end;
        }
        ...
        field(39003901; "Global Dimension 2 Code"; Code[20])
        {
            ...
            begin
                DimesionValue.Reset();
                DimesionValue.SetRange(Code, Rec."Global Dimension 2 Code");
                if DimesionValue.FindFirst() then
                    rec."Directorates Name" := DimesionValue.Name;
            end;
        }
        ...
        field(39003908; Grade; Code[20])
        {
            ...
            var
                myInt: Integer;
            begin
                "Old Value" += ',' + xRec.Grade;
                if "Old Value" <> '' then begin
                    rec."New Value" += ',' + rec.Grade;
                    rec."Field Modified" += ',' + rec.FieldName(Grade);
                end;
        ...
        field(39003981; "Job Title5"; Text[300])
        {
            Editable = false;
            Caption = 'Job Title5';
        }
        ...
        field(40045; "Highest level"; Integer)
        {
            ...
            begin
                ...
                if HrQualif.FindFirst() then
                    Rec."Highest Leverl Description" := HrQualif."Qualification Description";
            end;
        }
        ...
        field(39003900; "Global Dimension 1 Code"; Code[20])
        {
            ...
            begin
                ...
                "Old Value" += ',' + xRec."Global Dimension 1 Code";
                if "Old Value" <> '' then begin
                    rec."New Value" += ',' + rec."Global Dimension 1 Code";
                    rec."Field Modified" += ',' + rec.FieldName("Global Dimension 1 Code");
                end;
            end;
        }
        field(39003905; "Company E-Mail"; Text[50])
        {
            ...
            var
                myInt: Integer;
            begin
                "Old Value" += ',' + xRec."Company E-Mail";
                if "Old Value" <> '' then begin
                    rec."New Value" += ',' + rec."Company E-Mail";
                    rec."Field Modified" += ',' + rec.FieldName("Company E-Mail");
                end;

            end;
        }
        field(39004916; "Old Value"; text[1300])
        {
            DataClassification = ToBeClassified;
        }
        field(39005916; "New Value"; text[1300])
        {
            DataClassification = ToBeClassified;
        }
        field(39005917; "Field Modified"; Text[1000])
        {
            DataClassification = ToBeClassified;
        }
        field(39005918; "Directorates Name"; Text[100])
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(39004038; "Date captured"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(39004039; "Department acting"; Code[10])
        {
            TableRelation = "Responsibility Center BR NEW".Code;

            Caption = 'Department Acting';
            // CaptionClass = '1,1,2';
            ...
            begin
                ...
                Responsblece.SetRange(Code, Rec."Responsibility Center");
                if Responsblece.FindFirst() then
                    "DEpartment acting Name" := Responsblece.Name;
            end;
        }
        field(39004040; "DEpartment acting Name"; Text[200])
        {
            DataClassification = ToBeClassified;
        }
        field(39004041; "Can Issue"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
    ...
    begin
        if rec."Approval Status" <> rec."Approval Status"::Open then
            Error('Sorry, Deleting of documents at this stage is stricktly not permitted');
    end;
    ...
    begin
        ...
        if HrEmployeesRec.FindFirst() then begin
            ...
            if HrEmployeesRec.Disabled <> rec.Disabled then
                HrEmployeesRec.Disabled := rec.Disabled;
            if HrEmployeesRec."Department acting" <> rec."Department acting" then
                HrEmployeesRec."Department acting" := rec."Department acting";
            if HrEmployeesRec."Department acting Name" <> rec."DEpartment acting Name" then
                HrEmployeesRec."Department acting Name" := rec."DEpartment acting Name";
            if HrEmployeesRec."Exemption Certificate No." <> rec."Exemption Certificate No." then
                HrEmployeesRec."Exemption Certificate No." := rec."Exemption Certificate No.";
            if HrEmployeesRec."Incremental Month" <> rec."Incremental Month" then
                HrEmployeesRec."Incremental Month" := rec."Incremental Month";
            if HrEmployeesRec."Date of Current Employment" <> rec."Date of Current Employment" then
                HrEmployeesRec."Date of Current Employment" := rec."Date of Current Employment";
            ...
            if rec."Home Phone Number" <> '' then
                if HrEmployeesRec."Home Phone Number" <> rec."Home Phone Number" then
                    HrEmployeesRec."Home Phone Number" := rec."Home Phone Number";
            if rec."Work Phone Number" <> '' then
                if HrEmployeesRec."Work Phone Number" <> rec."Work Phone Number" then
                    HrEmployeesRec."Work Phone Number" := rec."Work Phone Number";
            ...
            if HrEmployeesRec."Global Dimension 2 Code" <> rec."Global Dimension 2 Code" then
                HrEmployeesRec.Validate(HrEmployeesRec."Global Dimension 2 Code", Rec."Global Dimension 2 Code");
            ...
            if HrEmployeesRec."Job ID5" <> rec."Job ID5" then
                HrEmployeesRec."Job ID5" := rec."Job ID5";
            if HrEmployeesRec."Reason For Acting" <> rec."Reason For Acting" then
                HrEmployeesRec."Reason For Acting" := rec."Reason For Acting";
            if HrEmployeesRec."Job Title5" <> rec."Job Title5" then
                HrEmployeesRec."Job Title5" := Rec."Job Title5";
            if HrEmployeesRec.Disabled <> Rec.Disabled then
                HrEmployeesRec.Validate(HrEmployeesRec.Disabled, Disabled);
            if HrEmployeesRec."Employee Type" <> rec."Employee Type" then
                HrEmployeesRec."Employee Type" := rec."Employee Type";
            if HrEmployeesRec."E-Mail" <> Rec."E-Mail" then
                HrEmployeesRec."E-Mail" := rec."E-Mail";
            if HrEmployeesRec."NSSF No." <> rec."NSSF No." then
                HrEmployeesRec."NSSF No." := rec."NSSF No.";
            if HrEmployeesRec."PIN No." <> rec."PIN No." then
                HrEmployeesRec."PIN No." := "PIN No.";
            if HrEmployeesRec."Type of Employee" <> Rec."Type of Employee" then
                HrEmployeesRec."Type of Employee" := rec."Type of Employee";
            if HrEmployeesRec."NHIF No." <> rec."NHIF No." then
                HrEmployeesRec."NHIF No." := rec."NHIF No.";
            if HrEmployeesRec.Acting <> rec.Acting then
                HrEmployeesRec.Acting := rec.Acting;
            ...
            if HrEmployeesRec."Job ID" <> Rec."Job ID" then begin
                payrollP.Reset();
                payrollP.SetRange(Closed, false);
                if payrollP.Find('-') then begin
                    HrEmployeesRec."Job ID" := Rec."Job ID";
                    JobHistory.Reset();
                    JobHistory.SetRange("No.", HrEmployeesRec."No.");
                    if JobHistory.FindLast() then begin
                        TotalH := JobHistory.Count;
                        EmploRec.Reset();
                        EmploRec.SetRange("No.", HrEmployeesRec."No.");
                        if EmploRec.FindFirst() then begin
                            JobHistory.Init();
                            JobHistory."Line No." := TotalH + 1;
                            JobHistory."E-Mail" := HrEmployeesRec."Company E-Mail";
                            JobHistory."No." := HrEmployeesRec."No.";
                            ...
                            JobHistory.Grade := rec."Salary Grade";
                            JobHistory."Period Filter" := payrollP."Date Opened";
                            JobHistory."Job ID" := rec."Job ID";
                        ...
                        if EmploRec.FindFirst() then begin
                            JobHistory.Init();
                            JobHistory."Line No." := 1;
                            JobHistory."E-Mail" := rec."Company E-Mail";
                            JobHistory."No." := HrEmployeesRec."No.";
                            JobHistory."Department Code" := EmploRec."Responsibility Center";
                            JobHistory."Department Name" := EmploRec."Department Name";
                            // JobHistory."Country Code" := EmploRec.County;
            ...
            if HrEmployeesRec."New Basic Pay" <> rec."New Basic Pay" then
                HrEmployeesRec."New Basic Pay" := rec."New Basic Pay";
            ...
            if HrEmployeesRec."Cell Phone Number" <> rec."Cell Phone Number" then
                HrEmployeesRec."Cell Phone Number" := rec."Cell Phone Number";
            if HrEmployeesRec."Home District" <> Rec."Home District" then
            ...
            if HrEmployeesRec."Highest level" <> rec."Highest level" then
                HrEmployeesRec.Validate(HrEmployeesRec."Highest level", rec."Highest level");
            if HrEmployeesRec."Highest level" <> Rec."Highest level" then
            ...
            if HrEmployeesRec."Date Of Birth" <> rec."Date Of Birth" then
                HrEmployeesRec.Validate(HrEmployeesRec."Date Of Birth");
            ...
            //ADDED field
            if HrEmployeesRec."Can Issue" <> Rec."Can Issue" then
                HrEmployeesRec."Can Issue" := rec."Can Issue";
            if HrEmployeesRec."Home District" <> Rec."Home District" then
                HrEmployeesRec."Home District" := Rec."Home District";
