...
table 52193550 "HR Employee Transfer Lines"
{
        ...
        field(2; "Employee No"; Code[50])
        {
            ...
            begin
                ...
                if Employees.Find('-') then begin
                    ...
                    "Current Designation" := Employees."Home District";
            ...
            begin
                ...
                if Dimensi.FindFirst() then begin
                    ...
                    if rec."Hardship Area" = false then
                        ...
                        Hrsetup.TestField("Hardship Allowance");
                        rec.Validate("HardShip Code", Hrsetup."Hardship Allowance");
                    end;
                end;
            end;
        }
        ...
        field(34; "Transaction Code"; Code[20])
        {
            ...
            begin
                ...
                if PRTransCode.Find('-') then begin
                    ...
                    Mobility.Reset();
                    Mobility.SetRange("Document No", Rec."Request No");
                    if Mobility.FindFirst() then begin
                        if Mobility.Type = Mobility.Type::"Management initiated" then
