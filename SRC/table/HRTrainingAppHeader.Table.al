...
table 52193496 "HR Training App Header"
{
    ...
    fields
    {
        ...
        field(49; "Perfomance Code"; Code[30])
        {
            DataClassification = ToBeClassified;
            TableRelation = "Appraisal Training Development"."Appraisal Code" where("Staff No" = field("Employee No_"));
            trigger OnValidate()
            var
                myInt: Integer;
                AppraisaTrai: Record "Appraisal Training Development";
            begin
                AppraisaTrai.Reset();
                AppraisaTrai.SetRange("Appraisal Code", rec."Perfomance Code");
                IF AppraisaTrai.FindFirst() then
                    Rec."Perfomance Course" := AppraisaTrai."Skills Gap";
            end;
        }
        field(50; "Perfomance Course"; Text[200])
        {
            DataClassification = ToBeClassified;
        }
