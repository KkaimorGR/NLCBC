...
table 52193429 "HR Emp Qualification Changes"
{
    ...
    fields
    {
        field(1; "Employee No."; Code[20])
        {
            ...
            begin
                ...
                "Other Qualification/Course Name" := '';
                Other := false;
                "Qualification Type" := '';
            end;
        }
        ...
        field(10; "Course Grade"; Code[100])
        {
        ...
        field(15; "Qualification Code"; Code[1000])
        {
            Editable = true;
            NotBlank = true;
            ...
            trigger OnValidate()
            var
                HRJOB: Record "HR Job Qualifications";
            begin
                "Qualification Description" := '';
                "Other Qualification/Course Name" := '';
                HRQualifications.Reset();
                HRQualifications.SetRange("Qualification Type", rec."Qualification Type");
                HRQualifications.SetRange(Code, rec."Qualification Code");
                if HRQualifications.FindFirst() then begin
                    //rec."Qualification Description" := HRQualifications.Description;
                    "Qualification Code" := HRQualifications.Description;
        ...
        field(50084; "Other"; Boolean)
        {
            ...
            var
                myInt: Integer;
            begin
                if Rec.Other = true then
                    "Qualification Code" := '' else begin
                    "Other Qualification/Course Name" := '';
                end;
            end;
        }
        field(500085; "Other Qualification/Course Name"; Text[200])
        {
            DataClassification = ToBeClassified;
        }
    }
    ...
    fieldgroups
    {
        fieldgroup(dropdown; "Qualfi Code", "Employee No.", Type, "Qualification Code", "Other Qualification/Course Name")
        {
    ...
    begin
        ...
        if HRQualicati.FindFirst() then begin
            ...
            if HrQuali.FindLast() then begin
                ...
                HrQuali."Other Qualification/Course Name" := rec."Other Qualification/Course Name";
                HrQuali.Other := rec.Other;
