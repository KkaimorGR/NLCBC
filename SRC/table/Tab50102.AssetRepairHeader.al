...
Table 52193470 "Asset Repair Header"
{
    ...
    fields
    {
        ...
        field(50004; "Department Name"; Text[200])
        {
    ...
    begin
        ...
        Employee.Reset();
        Employee.SetRange("User ID", rec."Requested By");
        if Employee.Find('-') then begin
            rec."Responsibility Center" := Employee."Responsibility Center";
        end;
    end;
