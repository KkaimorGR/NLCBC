...
table 52193870 "HR Disciplinary Cases NCA"
{
    ...
    fields
    {
        ...
        field(50016; "Response"; Text[1200])
        {
            Caption = 'Response';
        }
    ...
    trigger OnDelete()
    begin
        if ("Disciplinary Stage Status" <> "Disciplinary Stage Status"::" ") or ("Disciplinary Stage Status" <> "Disciplinary Stage Status"::Reported) then
