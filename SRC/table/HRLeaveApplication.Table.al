...
table 52193448 "HR Leave Application"
{
    ...
    fields
    {
        ...
        field(3; "Leave Type"; Code[30])
        {
            ...
            begin
                ...
                IF HREmp.FIND('-') THEN BEGIN
                    Acting := HREmp.Acting;
                    "Position Acting" := HREmp."Job Title5";
        ...
        field(4; "Days Applied"; Decimal)
        {
            ...
            begin
                hremployees.Reset();
                hremployees.SetRange("No.", rec."Employee No");
                if hremployees.FindFirst() then begin
                    rec."Responsibility Center" := hremployees."Responsibility Center";
                    // rec.Validate(rec."Responsibility Center");
                    rec."Leave Calendar" := hremployees."Leave Calendar";
                end;
        ...
        field(40004; Acting; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(40005; "Position Acting"; Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(40006; "Department acting"; Code[10])
        {
            TableRelation = "Responsibility Center BR NEW".Code;
        ...
        field(40007; "DEpartment acting Name"; Text[200])
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(30000; "Leave Calendar"; code[50])
        {
   ...
   */
    ...
    begin
        ...
        // ApprovalEntry.SetFilter(ApprovalEntry."Sequence No.", '>%1', 1);
        if ApprovalEntry.FindFirst() then begin
            HREmp.Reset();
            HREmp.SetRange("User ID", ApprovalEntry."Approver ID");
            if HREmp.FindFirst() then begin
                HREmp.TestField(HREmp."Company E-Mail");
                if Generalset."Allow send mails" = true then begin
                    ...
                    EmailMessage.Create(
                                        ...
                                        'You have approved leave application No .' + '<br>' + "Application Code" +// ' Leave Type ' + "Leave Type" +
    ...
    genset: Record "HR Setup";
    begin
        genset.get;

        HREmp.Get("Employee No");
        HREmp.TestField(HREmp."Company E-Mail");
        if genset."Allow send mails" = true then begin
