...
table 52193576 "HR Appraisal Header"
{
    ...
    fields
    {
        ...
        field(50036; "Second Supervisor"; Code[100])
        {
            TableRelation = "HR Employees"."No.";
            ...
            begin
                Hremployee.Reset();
                Hremployee.SetRange("No.", rec."Second Supervisor");
                if Hremployee.Find('-') then
                    rec."Second Supervisor Name" := Hremployee."Full Name";
        ...
        {
            CalcFormula = average("HR Objectives Targets"."Agreed Ratings" where("Appraisal Code" = field("Appraisal No"), Status = filter(Active)));
            FieldClass = FlowField;
