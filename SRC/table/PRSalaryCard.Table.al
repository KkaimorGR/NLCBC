...
table 52193602 "PR Salary Card"
{
        ...
        field(2; "Basic Pay"; Decimal)
        {
            ...
            begin
                ...
                if Userset.FindFirst() then
                    if Userset."Edit Basic Salary" = false then
                        Error('You are not authorized to edit the basic Salary');
    ...
    //*********************************************************************
        ...
        field(60021; "Pays NITA"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(60022; "Pays Housing Levy"; boolean)
        {
            DataClassification = ToBeClassified;
        }
    }
