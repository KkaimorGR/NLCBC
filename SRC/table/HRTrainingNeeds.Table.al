...
table 52193497 "HR Training Needs"
{
    ...
    fields
    {
        ...
        field(3; "Start Date"; Date)
        {
            ...
            begin
                ...
                CalculateDate();
                EmploREc.Reset();
                EmploREc.SetRange("User ID", rec."Captured By");
                if EmploREc.FindFirst() then begin
                    rec."Employee No" := EmploREc."No.";
                    rec."Responsibility Center" := EmploREc."Responsibility Center";
                end;
            end;
        }
        ...
        field(13; "Qualification Code"; Code[20])
        {
            ...
            begin
                ...
                if HRJobes.FindFirst() then begin
                    if HRJobes.Description <> '' then
        ...
        field(17; "Responsibility Center"; Code[10])
        {
            ...
            // TableRela/tion = "Dimension Value".Code where("Global Dimension No." = const(2));
            Caption = 'Department';
            // CaptionClass = '1,1,2';
        ...
        field(36; "Course Title"; Code[250])
        {
            ...
            TableRelation = "Appraisal Training Development"."Appraisal Code" where("Staff No" = field("Employee No"));
            trigger OnValidate()
            var
        ...
        field(37; "Course Description"; Text[200])
        {
            DataClassification = ToBeClassified;
        }
    ...
    fieldgroups
    {
        fieldgroup(Dropdown; Code, "Qualification Type", "Qualification Description", Duration)
        { }
    }
