...
Table 52194065 "Application Qualification"
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            OptionCaption = '" ",certificate,degree,diploma,higher diploma,k.c.s.e,kcpe,mba,post graduate diploma,prof/technical qualification,proffesional body,workshops/conferences/seminars,other';
            OptionMembers = " ",CERTIFICATE,DEGREE,DIPLOMA,"HIGHER DIPLOMA","K.C.S.E",KCPE,MBA,"POST GRADUATE DIPLOMA","PROF/TECHNICAL QUALIFICATION","PROFFESIONAL BODY","WORKSHOPS/CONFERENCES/SEMINARS",OTHER;
        }
        ...
        field(38; "Scoring Category"; Code[20])
        {
            DataClassification = ToBeClassified;
        }
        field(39; "Minimum Score"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(40; "Maximum Score"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(41; "Qualification Description"; Blob)
        {
            DataClassification = ToBeClassified;
        }
    }
