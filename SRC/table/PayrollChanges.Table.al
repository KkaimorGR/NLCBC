...
{
    DrillDownPageId = "Payroll changes List";
    LookupPageId = "Payroll changes List";
    ...
    fields
    {
                    ...
                    if Type = Type::"Existing Staff" then begin
                        ...
                        if RequestLines.FindFirst() then
                            repeat
                                ...
                                if PRSalary.FindFirst() then begin
                                    ...
                                    PRSalary.Reason := rec."Change Comments";
                                    PRSalary.Modify();
                                end;
                                if RequestLines."Existing Transaction Code" = 'BPAY' then begin
                                    Salarycard.Reset();
                                    Salarycard.SetRange("Employee Code", RequestLines."Employee Code");
                                    if Salarycard.FindFirst() then begin
                                        Salarycard."Basic Pay" := RequestLines."New Value";
                                        Salarycard.Validate(Salarycard."Basic Pay");
                                        Salarycard.Modify()
                                    end;
                                end;
                        ...
                        if Rec.Get(RequestLines."Payroll Change No") then begin
                            Rec."Payroll Updated" := true;
                            rec.Status := rec.Status::Approved;
                        end;
                        //Rec.Modify()
                    ...
                    if Type = Type::"New Staff" then begin
                        ...
                        if RequestLines.FindFirst() then begin
                            repeat
                                ...
                                PRSalary.SetRange(PRSalary."Payroll Period", rec."Payroll Period");
                                if not PRSalary.FindFirst() then begin
                                    PRSalary.Init();
        ...
        field(18; "Change Comments"; Text[200])
        {
