...
table 52193524 "HR Setup"
{
    ...
    fields
    {
        ...
        field(400016; "Basic Muiltipier"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(400017; "EmployerPIN"; Code[40])
        {
            DataClassification = ToBeClassified;
        }
        field(400018; SharePointUrl; Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(4000019; deleteSharepointUrl; Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(400020; "OTP Timeout"; Duration)
        {
            DataClassification = ToBeClassified;
        }
        field(79990; "Allow send mails"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
